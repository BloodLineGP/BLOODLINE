...
const DetailedPostPage = () => {
  ...
  const sendMessage = (event) => {
    ...
    if (message) {
      socket.emit("sendMessage", { message, id, name }, () => setMessage(""));
    }
        ...
        <div className="text-left flex items-stretch bg-gray-100 rounded shadow-lg p-4 px-4 md:p-8 mb-6  max-w-lg">
          <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-1 self-auto">
            <div className="text-gray-600">
              <p key={post.id} className="font-medium text-lg text-red-500">
            ...
            <div className="text-gray-600">
              <p className=" text-lg">Description: {post.description}</p>
            </div>

            <div className="text-gray-600">
              <p className=" text-lg">BloodType: {post.bloodType}</p>
            </div>
            ...
            <div className="text-gray-600">
              <p className=" text-lg">Published Date:{post.publishDate}</p>
            </div>
            ...
            <div className="text-gray-600">
              <p className=" text-lg">Post Type:{post.postType}</p>
            </div>
